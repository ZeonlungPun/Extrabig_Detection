...
def execute(labels_dir='',
            ...
            overlap_thresh=0.4,     #两个框重叠高于这个值会被去掉，越高去的越少
            max_edge_aspect_ratio=5,
            edge_buffer_test=1,
            groupby='image_path',
            groupby_cat='category',
    ...
    plot_path = os.path.join(out_results, plot_dir)
    ...
    csv_path = os.path.join(out_results, plot_dir, csv_name)
